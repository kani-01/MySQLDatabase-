<%-- 
    Document   : particularcategory
    Created on : 22 Apr, 2018, 7:29:04 PM
...
<html>
    <head>
        ...
        <title>Specific Category Page</title>
    </head>
    
    <body style ="background-color:#F7DC6F;">
        <h2>Books of Specific Category</h2>
        <%
...
//        if(userid.equals("abc")&&password.equals("abc"))
        ...
        try
        {
            ...
            ResultSet myRs = stmt.executeQuery("select * from book where SUBJECT_AREA ='"+category+"' ;");
		while(myRs.next())
		{
